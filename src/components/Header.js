...
const divisions = [
    { name: "Saving Product", path: "/products/saving_products" },
    { name: "Credit Product", path: "/products/credit_products" },
    { name: "Mobile Money", path: "/products/mobile_money" }
];
...
export default function Header() {
    ...
    return (
        <motion.header
            ...
            className="bg-[#f7d708] shadow-md fixed top-0 w-full z-50 backdrop-blur-md"
        >
            ...
            <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                ...
                >
                    <img src="/logo.png" width={80} style={{ borderRadius: 10 }} />
                    <div style={{ display: 'block', marginLeft: 10, alignContent: 'end' }}>
                        <p style={{ color: '#bc1f2d' }}>BINGET</p>
                        <p>microfinance</p>
                    </div>
